...
var stopWords = /^(maybe|ago|mean|oh|called|always|based|bit|set|sure|run|sort|last|able|question|thank|another|ok|kind|think|million|like|yeah|stuff|hard|first|back|might|things|particular|sometimes|around|although|little|give|yes|o|even|bs\.|used|want|thing|quite|point|perhaps|basically|hundred|thousand|obviously|something|probably|going|really|already|twenty|come|please|go|got|tell|one|two|three|six|seven|eight|nine|know|often|well|please|hopefully|five|four|lot|getting|d|r|just|get|actually|also|i|me|my|myself|we|us|our|ours|ourselves|you|your|yours|yourself|yourselves|he|him|his|himself|she|her|hers|herself|it|its|itself|they|them|their|theirs|themselves|what|which|who|whom|whose|this|that|these|those|am|is|are|was|were|be|been|being|have|has|had|having|do|does|did|doing|will|would|should|can|could|ought|i'm|you're|he's|she's|it's|we're|they're|i've|you've|we've|they've|i'd|you'd|he'd|she'd|we'd|they'd|i'll|you'll|he'll|she'll|we'll|they'll|isn't|aren't|wasn't|weren't|hasn't|haven't|hadn't|doesn't|don't|didn't|won't|wouldn't|shan't|shouldn't|can't|cannot|couldn't|mustn't|let's|that's|who's|what's|here's|there's|when's|where's|why's|how's|a|an|the|and|but|if|or|because|as|until|while|of|at|by|for|with|about|against|between|into|through|during|before|after|above|below|to|from|up|upon|down|in|out|on|off|over|under|again|further|then|once|here|there|when|where|why|how|all|any|both|each|few|more|most|other|some|such|no|nor|not|only|own|same|so|than|too|very|say|says|said|shall)$/,
...
function generate(font, spiral, scale, number) {
  layout
      .font(font)
      .spiral(spiral);
  ...
  words = [];
  layout.stop().words(tags.slice(0, max = Math.min(tags.length, number))).start();
}
...
(function() {
  ...
  socket.on('words', function(data)
  {
    ...
    tags = d3.entries(tags).sort(function(a, b) { return b.value - a.value; });
    tags.forEach(function(d) { d.key = cases[d.key]; });
    generate('Impact', 'archimedean', 'log', 100);
  });
})();
